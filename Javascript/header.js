...
$(function() {
    ...
    if (pathname == "/About/", pathname == "/CrimesAgainstFoodies/About/") {
    ...
    } else if (pathname == "/Home/", pathname == "/CrimesAgainstFoodies/Home/") {
        $('.header-right').append('<a class="active" href="../Home">Home</a>')
        $('.header-right').append('<a href="../About">About</a>')
        $('.header-right').append('<a href="../List">List</a>')
    } else if (pathname == "/List/", pathname == "/CrimesAgainstFoodies/List/") {
        $('.header-right').append('<a href="../Home">Home</a>')
        $('.header-right').append('<a href="../About">About</a>')
